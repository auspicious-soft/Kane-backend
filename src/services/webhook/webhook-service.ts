...
import { addedUserCreds, sendEmailVerificationMail } from "../../utils/mails/mail";
...
//         const existingVisitIndex = user.visitData.findIndex(
//           (visit: any) => visit.restaurantId.toString() === restaurant._id.toString()
//         );
...
//               if (item.DiscountAmount > item.Price) {
