...
import { createCouponsHistoryService, deleteCouponHistoryService, getAllCouponHistoriesService, getCouponHistoryByIdService, getUserCouponHistoryService, getUserEarnedCouponHistoryService, getUserRedeemCouponHistoryService, postApplyUserCouponService, updateCouponHistoryService, updateCouponStatusService } from "../../services/coupons-history/coupons-history-service";
...
export const updateCouponStatus = async (req: Request, res: Response) => {
  try {
    const response = await updateCouponStatusService(req.params.id, res);
    return res.status(httpStatusCode.OK).json(response);
  } catch (error: any) {
    const { code, message } = errorParser(error);
    return res
...
export const getUserEarnedCouponHistory = async (req: Request, res: Response) => {
  try {
    const response = await getUserEarnedCouponHistoryService(req.user,req.query, res);
    return res.status(httpStatusCode.OK).json(response);
  } catch (error: any) {
    const { code, message } = errorParser(error);
    return res
